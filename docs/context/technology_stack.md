...
| エディタ | 未定 | 未定 | 未定 |
| AIツール | 未定 | 未定 | 未定 |
| フロントエンド | Next.js 16.x系または作成時点のlatest / TypeScript / Node.js 24.14.1 / npm 11.11.0 / Tailwind CSS / 必要に応じてshadcn/ui | クライアント希望。画面中心のWebアプリを構築しやすい。Node.jsとnpmは現PCの環境を極力採用する | App Router / Pages Routerの最終決定、shadcn/uiを使用する範囲、TanStack Queryを使用する範囲 |
...
| 認証・認可 | メールログイン、パスワードリセット、セッション方式、Spring Security、CSRFトークン取得API、ロール別権限 | クライアント希望。システム管理者、プロジェクト管理者、メンバー、閲覧者で管理する | セッションCookie名、CSRFトークン取得APIのパス、CSRFヘッダー名 |
